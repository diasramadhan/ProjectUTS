                                    ...
                                    switch (pilih) {
                                        case 1:
                                            do {
                                                ...
                                                System.out.println("1. Tambah Jenis Makanan");
                                                System.out.println("2. Tambah Jenis Minuman");
                                            ...
                                            do {
                                                ...
                                                switch (pilih) {
                                                    case 1:
                                                        ...
                                                        if (pilih == 1) {
                                                            for (int i = 0; i < menumkn.length; i++) {
                                                                if (menumkn[i] != null && ubahmakan
                                                                        .equalsIgnoreCase(menumkn[i].getNama())) {
                                                    ...
                                                    case 2:
                                                        System.out.println("");
                                                        System.out
                                                                .print("Masukan Nama Jenis Minuman Yang Akan Diubah: ");
                                                        ubahmnm = sc.next();
                                                        ...
                                                        System.out.println("");
                                                        System.out.println(
                                                                "Ubah Cat " + ubahmnm + " Menjadi " + tubahmnm + "?");
                                                        System.out.println("1. Ubah");
                                                        System.out.println("2. Batal");
                                                        System.out.print("Pilih: ");
                                                        pilih = sc.nextInt();
